...
import "./Swap.css";
import { useGlobalContextPol } from "../contextPol";
const SwapPOLYGON = () => {
  const {
    l643Contract,
    l784Contract,
  ...
  const handleFromBalanceChange = async () => {
    try {
      ...
      if (fromCurrency == "AVAX") {
        const response = await avaxContract.balanceOf(walletAddress);
        setBalanceFrom(ethers.utils.formatUnits(response, 18));
      }
      ...
      <div className="container">
        <div className="buy">
          <form onSubmit={handleSwap}>
            ...
            >
              <option value="ETH">Wrapped Ether (WETH)</option>
